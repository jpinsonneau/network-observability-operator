...
func (in *DebugProcessorConfig) DeepCopyInto(out *DebugProcessorConfig) {
	*out = *in
	...
	if in.LokiMinBackoff != nil {
		in, out := &in.LokiMinBackoff, &out.LokiMinBackoff
		*out = new(v1.Duration)
		**out = **in
	}
	if in.LokiMaxBackoff != nil {
		in, out := &in.LokiMaxBackoff, &out.LokiMaxBackoff
		*out = new(v1.Duration)
		**out = **in
	}
	if in.LokiMaxRetries != nil {
		in, out := &in.LokiMaxRetries, &out.LokiMaxRetries
		*out = new(int32)
		**out = **in
	}
	if in.LokiStaticLabels != nil {
		in, out := &in.LokiStaticLabels, &out.LokiStaticLabels
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *FlowCollectorFLP) DeepCopyInto(out *FlowCollectorFLP) {
	*out = *in
	...
	in.Resources.DeepCopyInto(&out.Resources)
	if in.LokiTimeout != nil {
		in, out := &in.LokiTimeout, &out.LokiTimeout
		*out = new(v1.Duration)
		**out = **in
	}
	if in.LokiBatchWait != nil {
		in, out := &in.LokiBatchWait, &out.LokiBatchWait
		*out = new(v1.Duration)
		**out = **in
	}
